...
InvPrimed ==
  ((((((TRUE
              ...
              /\ (\A x_0$6 \in Node: x_0$6 \in alive' \/ ~(x_0$6 \in go_abort')))
            /\ (\A x_0$7 \in Node:
              x_0$7 \in alive' \/ ~(x_0$7 \in decide_abort')))
          /\ (\A x_0$8 \in Node:
            x_0$8 \in go_commit' \/ ~(x_0$8 \in decide_commit')))
        /\ (\A x_0$9 \in Node: x_0$9 \in vote_yes' \/ ~(x_0$9 \in vote_no')))
      /\ (\A x_0$10 \in Node:
        x_0$10 \in decide_abort' \/ ~(x_0$10 \in decide_commit')))
