...
InvPrimed ==
  ((((TRUE
          ...
          /\ (\A x_0$5 \in Node: x_0$5 \in alive' \/ ~(x_0$5 \in go_abort')))
        /\ (\A x_0$6 \in Node: x_0$6 \in alive' \/ ~(x_0$6 \in decide_abort')))
      /\ (\A x_0$7 \in Node: x_0$7 \in go_commit' \/ ~(x_0$7 \in decide_commit')))
    /\ (\A x_0$8 \in Node: x_0$8 \in vote_yes' \/ ~(x_0$8 \in vote_no'))
