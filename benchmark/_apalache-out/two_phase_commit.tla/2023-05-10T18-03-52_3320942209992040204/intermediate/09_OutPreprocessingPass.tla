...
Inv ==
  (((((((TRUE
      ...
      /\ ((vote_yes \in SUBSET Node
        ...
        /\ ((\A n$15 \in Node:
            \A n2$4 \in Node:
              ~(n$15 \in decide_commit) \/ ~(n2$4 \in decide_abort))
          /\ (\A n$16 \in Node:
            \A n2$5 \in Node: ~(n$16 \in decide_commit) \/ n2$5 \in vote_yes)
          /\ (\A n$17 \in Node:
            \A n2$6 \in Node: ~(n$17 \in decide_abort) \/ abort_flag))))
...
InvPrimed ==
  (((((((TRUE
                ...
                /\ (\A x_0$7 \in Node:
                  x_0$7 \in alive' \/ ~(x_0$7 \in go_abort')))
              /\ (\A x_0$8 \in Node:
                x_0$8 \in alive' \/ ~(x_0$8 \in decide_abort')))
            /\ (\A x_0$9 \in Node:
              x_0$9 \in go_commit' \/ ~(x_0$9 \in decide_commit')))
          /\ (\A x_0$10 \in Node: x_0$10 \in vote_yes' \/ ~(x_0$10 \in vote_no')))
        /\ (\A x_0$11 \in Node:
          x_0$11 \in decide_abort' \/ ~(x_0$11 \in decide_commit')))
      /\ (((\E t_a$1 \in SUBSET Node: vote_yes' = t_a$1)
          /\ (\E t_b$1 \in SUBSET Node: vote_no' = t_b$1)
          /\ (\E t_c$1 \in SUBSET Node: alive' = t_c$1)
          /\ (\E t_d$1 \in SUBSET Node: go_commit' = t_d$1)
          /\ (\E t_e$1 \in SUBSET Node: go_abort' = t_e$1)
          /\ (\E t_f$1 \in SUBSET Node: decide_commit' = t_f$1)
          /\ (\E t_g$1 \in SUBSET Node: decide_abort' = t_g$1)
          /\ (\E t_h$1 \in BOOLEAN: abort_flag' = t_h$1))
        /\ ((\A n$18 \in Node:
            \A n2$7 \in Node:
              ~(n$18 \in decide_commit') \/ ~(n2$7 \in decide_abort'))
          /\ (\A n$19 \in Node:
            \A n2$8 \in Node: ~(n$19 \in decide_commit') \/ n2$8 \in vote_yes')
          /\ (\A n$20 \in Node:
            \A n2$9 \in Node: ~(n$20 \in decide_abort') \/ abort_flag'))))
    /\ (\A x_0$12 \in Node: x_0$12 \in vote_no' \/ ~(x_0$12 \in decide_abort'))
...
VCInv_si_8 ==
  \A n$21 \in Node:
    \A n2$10 \in Node: ~(n$21 \in decide_commit) \/ ~(n2$10 \in decide_abort)
...
VCNotInv_si_8 ==
  \E n$22 \in Node:
    \E n2$11 \in Node: n$22 \in decide_commit /\ n2$11 \in decide_abort
...
VCInv_si_9 ==
  \A n$23 \in Node:
    \A n2$12 \in Node: ~(n$23 \in decide_commit) \/ n2$12 \in vote_yes
...
VCNotInv_si_9 ==
  \E n$24 \in Node:
    \E n2$13 \in Node: n$24 \in decide_commit /\ ~(n2$13 \in vote_yes)

(*
  @type: Bool;
*)
VCInv_si_10 ==
  \A n$25 \in Node: \A n2$14 \in Node: ~(n$25 \in decide_abort) \/ abort_flag

(*
  @type: Bool;
*)
VCNotInv_si_10 ==
  \E n$26 \in Node: \E n2$15 \in Node: n$26 \in decide_abort /\ ~abort_flag
