...
Inv ==
  (((((((TRUE
                  /\ (vote_yes \in SUBSET Node
                    ...
                    /\ decide_abort \in SUBSET Node
                    /\ abort_flag \in BOOLEAN))
                /\ (\A x_0$7 \in Node: x_0$7 \in alive \/ ~(x_0$7 \in go_abort)))
              /\ (\A x_0$8 \in Node:
      ...
      /\ ((vote_yes \in SUBSET Node
          ...
          /\ abort_flag \in BOOLEAN)
        /\ ((\A n$24 \in Node:
            \A n2$7 \in Node: n$24 \in decide_commit => n2$7 \notin decide_abort)
          /\ (\A n$25 \in Node:
            \A n2$8 \in Node: n$25 \in decide_commit => n2$8 \in vote_yes)
          /\ (\A n$26 \in Node:
            \A n2$9 \in Node: n$26 \in decide_abort => abort_flag))))
