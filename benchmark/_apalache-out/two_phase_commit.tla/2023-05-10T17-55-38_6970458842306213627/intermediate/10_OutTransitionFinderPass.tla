...
VCNotInv_si_8 ==
  \E n$13 \in Node:
    \E n2$2 \in Node: n$13 \in decide_commit /\ n2$2 \in decide_abort
...
VCNotInv_si_9 ==
  \E n$15 \in Node:
    \E n2$4 \in Node: n$15 \in decide_commit /\ ~(n2$4 \in vote_yes)
...
*)
VCNotInv_si_10 ==
  \E n$17 \in Node: \E n2$6 \in Node: n$17 \in decide_abort /\ ~abort_flag
