...
Inv ==
  (((TRUE
          /\ (vote_yes \in SUBSET Node
            ...
            /\ decide_abort \in SUBSET Node
            /\ abort_flag \in BOOLEAN))
        /\ (\A x_0$4 \in Node: x_0$4 \in alive \/ ~(x_0$4 \in go_abort)))
      /\ (\A x_0$5 \in Node: x_0$5 \in alive \/ ~(x_0$5 \in decide_abort)))
    /\ (\A x_0$6 \in Node: x_0$6 \in go_commit \/ ~(x_0$6 \in decide_commit))
