...
PPrimed ==
  (\E t_2$1 \in [RM -> { "working", "prepared", "committed", "aborted" }]:
      rmState' = t_2$1)
    /\ (\A rm1$2 \in RM:
      \A rm2$2 \in RM:
...
VCInv_si_1 ==
  \A rm1$3 \in RM:
    \A rm2$3 \in RM:
      ~(rmState[rm1$3] = "aborted") \/ ~(rmState[rm2$3] = "committed")
...
VCNotInv_si_1 ==
  \E rm1$4 \in RM:
    \E rm2$4 \in RM: rmState[rm1$4] = "aborted" /\ rmState[rm2$4] = "committed"
