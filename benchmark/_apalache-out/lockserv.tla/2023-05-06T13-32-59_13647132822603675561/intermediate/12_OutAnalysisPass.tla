...
*)
VCNotInv_si_0 ==
  Skolem((\E x$2 \in Node:
    Skolem((\E y$2 \in Node:
      (holds_lock[x$2] /\ holds_lock[y$2]) /\ ~(x$2 = y$2)))))

(*
  @type: Bool;
*)
VCInv_si_1 == DOMAIN lock_msg = Node

(*
  @type: Bool;
*)
VCNotInv_si_1 == ~(DOMAIN lock_msg = Node)

(*
  @type: Bool;
*)
VCInv_si_2 == DOMAIN grant_msg = Node

(*
  @type: Bool;
*)
VCNotInv_si_2 == ~(DOMAIN grant_msg = Node)

(*
  @type: Bool;
*)
VCInv_si_3 == DOMAIN unlock_msg = Node

(*
  @type: Bool;
*)
VCNotInv_si_3 == ~(DOMAIN unlock_msg = Node)

(*
  @type: Bool;
*)
VCInv_si_4 == DOMAIN holds_lock = Node

(*
  @type: Bool;
*)
VCNotInv_si_4 == ~(DOMAIN holds_lock = Node)
